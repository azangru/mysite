...
(function() {
  $(function() {
    var $main, $sidebarMenu, closeSidebar, openSidebar;
    ...
    openSidebar = function() {
      ...
      return $main.removeClass('with-sidemenu-closed').addClass('with-sidemenu-open');
    };
    closeSidebar = function() {
      $sidebarMenu.removeClass('open-sidebar').addClass('closed-sidebar');
      return $main.removeClass('with-sidemenu-open').addClass('with-sidemenu-closed');
    };
    return $("code").parent('a').hover(function() {
