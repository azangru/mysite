...
- [Python for Data Science, by Arthur Turrell](https://aeturrell.github.io/python4DS/welcome.html)
...
- [Build a Large Language Model (from scratch)](https://www.youtube.com/playlist?list=PLTKMiZHVd_2IIEsoJrWACkIxLRdfMlw11)
  - [Youtube playlist of a course created by Manning Publications](https://www.youtube.com/playlist?list=PLQRyiBCWmqp5twpd8Izmaxu5XRkxd5yC-)
...
## Yandex (in Russian)
- Varous useful [links](https://yandex.ru/yaintern/schools/useful), mostly in Russian, including:
  - [Python handbook](https://education.yandex.ru/handbook/python)
  - [Algorithms handbook](https://education.yandex.ru/handbook/algorithms)
  - [Machine learning handbook](https://education.yandex.ru/handbook/ml)
- [Repository](https://github.com/andreypomortsev/yndx-python-handbook) of problem sets for Yandex python handbook 
- [Introduction to Machine Learning - repository of materials and problem sets](https://github.com/girafe-ai/intro-to-ml-harbour)
